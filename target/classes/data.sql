...
('Булгур отварной', 'EASY', 'Отварной булгур'),
('Киноа отварная', 'EASY', 'Отварная киноа'),
('Нут с оливковым маслом', 'EASY', 'Нут с маслом'),
('Фасоль с луком', 'EASY', 'Фасоль с луком'),

('Кабачки жареные', 'EASY', 'Обжаренные кабачки'),
('Баклажаны жареные', 'EASY', 'Обжаренные баклажаны'),
('Шпинат тушёный', 'EASY', 'Тушёный шпинат'),
('Спаржа жареная', 'MEDIUM', 'Обжаренная спаржа'),
('Артишоки тушёные', 'MEDIUM', 'Тушёные артишоки'),
('Салат айсберг с маслом', 'EASY', 'Листья салата с маслом'),
('Руккола с пармезаном', 'MEDIUM', 'Руккола и сыр'),

('Картофель с укропом', 'EASY', 'Картофель с укропом'),
('Омлет с петрушкой', 'EASY', 'Омлет с зеленью'),
('Рис с лавровым листом', 'EASY', 'Рис с ароматом лавра'),
('Овощи с паприкой', 'EASY', 'Овощи со специей'),
('Паста с орегано', 'EASY', 'Паста с ароматными травами'),

('Салат с соевым соусом', 'MEDIUM', 'Овощи с соевым соусом'),
('Салат с горчицей', 'MEDIUM', 'Овощи с горчичной заправкой'),
('Помидоры с бальзамиком', 'MEDIUM', 'Томаты с уксусом'),
('Паста с каперсами', 'MEDIUM', 'Паста с каперсами'),

('Утиная грудка жареная', 'HARD', 'Обжаренная утка'),
('Перепела запечённые', 'HARD', 'Запечённые перепела'),
('Угорь жареный', 'HARD', 'Жареный угорь'),
('Анчоусы с маслом', 'MEDIUM', 'Анчоусы в масле'),
('Морские гребешки жареные', 'HARD', 'Гребешки на сковороде'),
('Салат с крабом', 'HARD', 'Мясо краба с салатом'),

('Миндаль обжаренный', 'EASY', 'Обжаренный миндаль'),
('Творог с изюмом', 'EASY', 'Творог с сухофруктами'),
('Яблоки с мёдом', 'EASY', 'Фрукты с мёдом')
ON CONFLICT (name) DO NOTHING;
...
-- тунец
(r.name = 'Тунец с сыром' AND i.name IN ('Тунец консервированный','Сыр Чеддер')) OR
-- крупы
(r.name = 'Булгур отварной' AND i.name = 'Булгур') OR
(r.name = 'Киноа отварная' AND i.name = 'Киноа') OR
(r.name = 'Нут с оливковым маслом' AND i.name IN ('Нут консервированный','Оливковое масло')) OR
(r.name = 'Фасоль с луком' AND i.name IN ('Фасоль консервированная','Репчатый лук')) OR

-- овощи
(r.name = 'Кабачки жареные' AND i.name = 'Кабачки') OR
(r.name = 'Баклажаны жареные' AND i.name = 'Баклажаны') OR
(r.name = 'Шпинат тушёный' AND i.name = 'Шпинат') OR
(r.name = 'Спаржа жареная' AND i.name = 'Спаржа') OR
(r.name = 'Артишоки тушёные' AND i.name = 'Артишоки') OR
(r.name = 'Салат айсберг с маслом' AND i.name IN ('Салат айсберг','Оливковое масло')) OR
(r.name = 'Руккола с пармезаном' AND i.name IN ('Руккола','Пармезан')) OR

-- зелень
(r.name = 'Картофель с укропом' AND i.name IN ('Картофель','Укроп')) OR
(r.name = 'Омлет с петрушкой' AND i.name IN ('Яйца куриные','Петрушка')) OR
(r.name = 'Рис с лавровым листом' AND i.name IN ('Рис белый','Лавровый лист')) OR
(r.name = 'Овощи с паприкой' AND i.name = 'Паприка') OR
(r.name = 'Паста с орегано' AND i.name IN ('Макаронные изделия','Орегано')) OR

-- соусы
(r.name = 'Салат с соевым соусом' AND i.name = 'Соевый соус') OR
(r.name = 'Салат с горчицей' AND i.name = 'Горчица') OR
(r.name = 'Помидоры с бальзамиком' AND i.name IN ('Помидоры','Уксус бальзамический')) OR
(r.name = 'Паста с каперсами' AND i.name IN ('Макаронные изделия','Каперсы')) OR

-- мясо / рыба
(r.name = 'Утиная грудка жареная' AND i.name = 'Утиная грудка') OR
(r.name = 'Перепела запечённые' AND i.name = 'Перепела') OR
(r.name = 'Угорь жареный' AND i.name = 'Угорь') OR
(r.name = 'Анчоусы с маслом' AND i.name IN ('Анчоусы','Оливковое масло')) OR
(r.name = 'Морские гребешки жареные' AND i.name = 'Морские гребешки') OR
(r.name = 'Салат с крабом' AND i.name IN ('Мясо краба','Салат айсберг')) OR

-- сладкое
(r.name = 'Миндаль обжаренный' AND i.name = 'Миндаль') OR
(r.name = 'Творог с изюмом' AND i.name IN ('Творог','Изюм')) OR
(r.name = 'Яблоки с мёдом' AND i.name IN ('Яблоки','Мед'))
